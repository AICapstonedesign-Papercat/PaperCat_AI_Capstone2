  ...
  return (
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <View style={s.nav}>
        ...
        <Image source={require('../../../assets/cat/pose-thinking.png')} style={{ width: 36, height: 36, marginRight: 8, resizeMode: 'contain' }} />
        <View style={{ flex: 1 }}>
          ...
          {messages.map((m, i) => (
            m.who === 'cat' ? (
              ...
              <View key={i} style={s.catRow}>
                <Image source={require('../../../assets/cat/pose-thinking.png')} style={{ width: 34, height: 34, resizeMode: 'contain' }} />
